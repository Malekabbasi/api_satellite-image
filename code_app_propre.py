...
def get_sentinelhub_config() -> SHConfig:
    config = SHConfig()
    config.sh_client_id = os.getenv("SENTINELHUB_CLIENT_ID", "717ecca7-4812-4c68-af58-b26ce8ebba34")
    config.sh_client_secret = os.getenv("SENTINELHUB_CLIENT_SECRET", "5dJtkf3sR4jfXpEzscvBBLspyKnMXO8P")
    return config
